CREATE TABLE IF NOT EXISTS community_posts (
    ...
    CONSTRAINT chk_community_posts_visibility
...
CREATE TABLE IF NOT EXISTS community_post_media (
    ...
    CONSTRAINT chk_community_post_media_type
...
CREATE TABLE IF NOT EXISTS community_reactions (
    ...
    CONSTRAINT chk_community_reactions_type
        CHECK (reaction_type IN ('LIKE', 'LOVE', 'WOW', 'CARE')),
    CONSTRAINT uq_community_reactions_post_user
...
CREATE INDEX IF NOT EXISTS idx_community_post_media_post
    ON community_post_media (post_id, sort_order ASC);
